...
__all__ = [
    'SpCustomStream', 'eWORDTYPE_ADDED', 'SAFT12kHz16BitStereo',
    'SP_VISEME_19', 'SP_VISEME_0', 'eLEXTYPE_RESERVED8',
    'eLEXTYPE_PRIVATE3', 'SRAImport',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPAUDIOBUFFERINFO',
    'SpObjectToken', 'SAFT16kHz8BitMono', 'SpeechTokenKeyAttributes',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SVSLastBookmark',
    'DISPID_SPAStartElementInResult', 'DISPID_SGRSTRule',
    'DISPID_SOTsCount', 'SpWaveFormatEx', 'eLEXTYPE_PRIVATE15',
    'DISPID_SVSLastResult',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    '_RemotableHandle', 'SPPHRASE', 'SVP_9', 'SVEEndInputStream',
    'SVP_21', 'SPEI_TTS_AUDIO_LEVEL', 'SVSFPersistXML',
    'WAVEFORMATEX', 'eLEXTYPE_PRIVATE12', 'SpeechLexiconType',
    'DISPID_SPISaveToMemory', 'SAFTExtendedAudioFormat',
    'DISPID_SRGetPropertyString', 'SSTTDictation', 'SVSFUnusedFlags',
    'SPBO_NONE', 'ISpAudio', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRGReset', 'SpInProcRecoContext',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SREmulateRecognition',
    'SpeechRegistryUserRoot', 'SREPrivate',
    'SpeechCategoryPhoneConverters', 'DISPID_SOTCreateInstance',
    'SPGRAMMARWORDTYPE', 'DISPID_SRAudioInput',
    'SPRST_INACTIVE_WITH_PURGE', 'SPRULESTATE',
    'SpeechRecognizerState', 'DISPID_SRCESoundEnd',
    'DISPID_SOTCGetDataKey', 'SAFT24kHz16BitStereo', 'SVEBookmark',
    'SVPOver', 'SpeechPropertyHighConfidenceThreshold',
    'SpeechCategoryAudioOut', 'DISPID_SDKDeleteValue', 'SPEI_MIN_SR',
    'DISPID_SLPSymbolic', 'SP_VISEME_18', 'DISPID_SVEPhoneme',
    'SRESoundEnd', 'SpeechVoiceSkipTypeSentence', 'SPPS_RESERVED3',
    'DISPID_SMSADeviceId', 'ISpStreamFormatConverter',
    'DISPID_SVEventInterests', 'SPRST_NUM_STATES',
    'SpeechEmulationCompareFlags', 'DISPID_SPRuleFirstElement',
    'DISPID_SGRsCommitAndSave', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SGDSActiveUserDelimited', 'DISPID_SAFGetWaveFormatEx',
    'SRAORetainAudio', 'ISpeechAudio', 'SDTAll',
    'SPSMF_SAPI_PROPERTIES', 'SpeechEngineConfidence',
    'DISPID_SpeechBaseStream', 'SpeechFormatType',
    'DISPIDSPTSI_ActiveLength', 'SDA_No_Trailing_Space',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SPEsItem',
    'SPDKL_DefaultLocation', 'DISPID_SVEAudioLevel', 'SVEVoiceChange',
    'DISPID_SPILanguageId', 'SVP_1', 'DISPID_SDKSetBinaryValue',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SLWLangId',
    'DISPID_SDKOpenKey', 'SPAS_STOP', 'SPBO_TIME_UNITS',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SBSWrite',
    'SpeechPartOfSpeech', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPADAPTATIONRELEVANCE', 'SPEI_VISEME', 'SRERecognition',
    'DISPID_SPRs_NewEnum', 'IEnumString', 'ISpeechFileStream',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SP_VISEME_13',
    'SpSharedRecognizer', 'ISpeechGrammarRule', 'SVSFDefault',
    'eLEXTYPE_RESERVED10', 'eLEXTYPE_PRIVATE4',
    'DISPID_SPPFirstElement', 'SAFT48kHz16BitMono', 'SVEAudioLevel',
    'eLEXTYPE_PRIVATE6', 'DISPID_SPELexicalForm',
    'SAFT32kHz16BitStereo', 'DISPID_SVGetAudioInputs',
    'DISPID_SVGetProfiles', 'SPXRO_Alternates_SML',
    'SPXMLRESULTOPTIONS', 'DISPID_SRRTimes', 'SP_VISEME_20',
    'eLEXTYPE_VENDORLEXICON', 'SPAO_NONE',
    'SpeechCategoryRecoProfiles', 'ISpObjectWithToken',
    'ISpNotifySource', 'SPEI_ADAPTATION', 'DISPID_SMSGetData',
    'SRSInactiveWithPurge', 'DISPID_SOTCId', 'SPDKL_CurrentUser',
    'DISPID_SRRRecoContext', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SOTRemoveStorageFileName', 'SVEPrivate',
    'DISPID_SAFSetWaveFormatEx', 'ISpeechWaveFormatEx', 'SITooLoud',
    'SAFTGSM610_8kHzMono', 'DISPID_SGRSTransitions',
    'DISPID_SpeechWaveFormatEx', 'SSFMOpenForRead', 'SDTLexicalForm',
    'SP_VISEME_4', 'DISPID_SRGRules', 'SVP_13', 'DISPID_SLPsItem',
    'SpCompressedLexicon', 'SVESentenceBoundary',
    'ISpeechLexiconWords', 'SpeechAudioProperties',
    'Speech_Max_Pron_Length', 'ISpMMSysAudio',
    'SpeechAudioFormatGUIDText', 'SVEAllEvents',
    'SpeechRecognitionType', 'SPINTERFERENCE_NONE', 'SVP_8',
    'SREAdaptation', 'SPAR_High', 'SRAInterpreter',
    'SpeechDictationTopicSpelling', 'SpPhraseInfoBuilder',
    'DISPID_SAFType', 'SpeechLoadOption',
    'SpeechPropertyResponseSpeed', 'SPSHT_Unknown',
    'SAFT11kHz8BitStereo', 'DISPID_SPCIdToPhone',
    'SECFNoSpecialChars', 'ISpeechVoiceStatus',
    'DISPID_SVGetAudioOutputs', 'SpeechTokenKeyFiles',
    'SPPHRASEPROPERTY', 'SPEI_MAX_SR', 'SpMMAudioIn',
    'DISPID_SpeechRecoResultTimes', 'SpeechInterference',
    'SpeechPropertyLowConfidenceThreshold', 'eLEXTYPE_PRIVATE11',
    '__MIDL_IWinTypes_0009', 'DISPID_SpeechPhoneConverter',
    'ISpeechRecoResult', 'SPDKL_LocalMachine', 'SVP_10',
    'SpeechDiscardType', 'DISPID_SPPsItem', 'SPPHRASERULE',
    'DISPID_SLWType', 'DISPID_SRGCmdLoadFromObject',
    'SPPS_NotOverriden', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SRRecognizer', 'SVSFNLPSpeakPunc', 'STSF_LocalAppData',
    'ISpeechBaseStream', 'DISPID_SRGetRecognizers', 'SVP_17',
    'ISpRecoGrammar', 'DISPID_SRCRecognizer',
    'ISpeechLexiconPronunciation', 'SRADefaultToActive', 'SWTAdded',
    'ISpeechObjectToken', 'SAFT16kHz8BitStereo', 'SPWF_INPUT',
    'SPAS_CLOSED', 'SPCATEGORYTYPE', 'SWPUnknownWordUnpronounceable',
    'SAFT22kHz8BitMono', 'SPFM_NUM_MODES', 'SRSEIsSpeaking',
    'DISPID_SOTRemove', 'DISPID_SPRDisplayAttributes',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SRCState',
    'SPLO_STATIC', 'SVSFlagsAsync', 'SASRun', 'SLTUser',
    'DISPID_SRGetPropertyNumber', 'DISPID_SPIGetDisplayAttributes',
    'SAFT22kHz16BitMono', 'SPFILEMODE', 'eLEXTYPE_LETTERTOSOUND',
    'SPEI_SOUND_START', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SpeechLexicon', 'DISPID_SPIEngineId',
    '_ISpeechVoiceEvents', 'DISPID_SOTGetDescription',
    'DISPID_SPPValue', 'DISPID_SRSSupportedLanguages',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SOTIsUISupported',
    'ISpeechRecognizerStatus', 'SpMMAudioEnum',
    'DISPID_SPRules_NewEnum', 'DISPID_SRCSetAdaptationData',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SGRInitialState',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SOTs_NewEnum',
    'DISPID_SVAlertBoundary', 'DISPID_SBSRead', 'SPWT_DISPLAY',
    'SECHighConfidence', 'DISPID_SVAudioOutputStream',
    'DISPID_SpeechRecoContext', 'ISpSerializeState',
    'SAFT12kHz8BitMono', 'SRTStandard', 'SAFTADPCM_11kHzMono',
    'SpeechEngineProperties', 'SPINTERFERENCE_NOSIGNAL', 'SVP_3',
    'SPRECOCONTEXTSTATUS', 'DISPID_SLPLangId', 'DISPID_SPAPhraseInfo',
    'SPINTERFERENCE_TOOQUIET', 'SpeechStreamSeekPositionType',
    'DISPID_SVESentenceBoundary', 'SpeechRuleState',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SpeechAudio',
    'DISPID_SDKDeleteKey', 'DISPID_SVAudioOutput', 'SP_VISEME_12',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpeechWordType',
    'DISPID_SCSBaseStream', 'DISPID_SRCEPhraseStart',
    'ISpeechRecoGrammar', 'DISPID_SPIEnginePrivateData', 'SSFMCreate',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPEEngineConfidence',
    'SpeechGrammarTagUnlimitedDictation', 'SPGRAMMARSTATE',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SAVolume',
    'STCRemoteServer', 'SPVISEMES', 'DISPID_SRRTStreamTime',
    'SPEI_SENTENCE_BOUNDARY', 'SAFTADPCM_44kHzStereo',
    'SAFT32kHz16BitMono', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SRCEBookmark',
    'DISPID_SPIReplacements', 'DISPID_SRGDictationLoad', 'ISpVoice',
    'SAFT24kHz8BitStereo', 'DISPID_SpeechObjectToken', 'SP_VISEME_1',
    'eLEXTYPE_PRIVATE17', 'DISPID_SDKSetLongValue',
    'SPEI_PHRASE_START', 'DISPID_SRSetPropertyNumber',
    'DISPID_SDKGetStringValue', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SBSFormat', 'UINT_PTR', 'DISPID_SRRSaveToMemory',
    'SPWT_LEXICAL', 'DISPID_SLWsCount', 'SpMemoryStream',
    'SpPhoneticAlphabetConverter', 'SPCT_SUB_COMMAND',
    'SDKLDefaultLocation', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SGRsCommit', 'SRTEmulated', 'SRESoundStart',
    'SpMMAudioOut', 'DISPID_SGRId', 'ISpObjectTokenCategory',
    'DISPID_SGRSTsItem', 'DISPIDSPRG', 'DISPID_SPARecoResult',
    'SPWORDPRONUNCIATIONLIST', 'IInternetSecurityMgrSite', 'SVP_5',
    'DISPID_SpeechRecoResult2', 'SpeechRecoEvents',
    'DISPID_SpeechPhraseReplacement', 'DISPIDSPTSI',
    'DISPID_SRSCurrentStreamNumber', 'SPVPRIORITY',
    'DISPID_SVIsUISupported', 'DISPID_SGRSTPropertyId', 'SP_VISEME_5',
    'SECFIgnoreCase', 'SPINTERFERENCE_NOISE', 'DISPID_SRIsShared',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SOTsItem',
    'DISPID_SpeechLexiconWord', 'DISPID_SPPId',
    'SpeechTokenValueCLSID', 'ISpeechPhoneConverter',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SDKEnumValues',
    'DISPID_SPRFirstElement', 'SpLexicon', 'DISPID_SRRAudio',
    'DISPID_SWFEExtraData', 'DISPID_SVPriority', 'SECLowConfidence',
    'DISPID_SAFGuid', 'DISPID_SGRClear', 'SVPNormal',
    'DISPID_SGRSAddWordTransition', 'DISPID_SDKGetlongValue',
    'eLEXTYPE_USER', 'SPPARTOFSPEECH', 'DISPID_SPAsCount',
    'SPEI_START_SR_STREAM', 'ISpNotifyTranslator', 'DISPID_SAStatus',
    'SAFT48kHz8BitMono', 'SPEI_END_INPUT_STREAM',
    'SSSPTRelativeToStart', 'SpeechRuleAttributes',
    'DISPID_SPEsCount', 'SPEI_PROPERTY_STRING_CHANGE', 'SVP_0',
    'DISPID_SLPType', 'SPEI_RESERVED6', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SABufferInfo', 'SINoSignal', 'SVSFVoiceMask',
    'SGRSTTEpsilon', 'DISPID_SPIStartTime', 'DISPID_SRCBookmark',
    'SPBINARYGRAMMAR', 'ISpRecoGrammar2', 'DISPID_SPEAudioSizeTime',
    'SVSFIsXML', 'DISPID_SVSInputWordLength',
    ...
    'DISPID_SPCPhoneToId', 'SGDSInactive', 'SpeechVoiceEvents',
    'DISPID_SpeechCustomStream', 'SPCT_SLEEP', 'SPSHT_OTHER',
    'SpeechRecoProfileProperties', 'DISPID_SPRText', 'SpFileStream',
    'ISpeechPhraseReplacement', 'DISPID_SOTId', 'DISPID_SVEStreamEnd',
    'SGLexicalNoSpecialChars', 'SPFM_CREATE',
    'ISpeechLexiconPronunciations', 'SFTSREngine',
    'DISPID_SpeechXMLRecoResult', 'SPCT_SUB_DICTATION', 'SPSFunction',
    'SPPHRASEREPLACEMENT', 'DISPID_SRState', 'SpeechTokenContext',
    'DISPID_SPPNumberOfElements', 'DISPID_SPPConfidence',
    'DISPID_SGRSTs_NewEnum', 'SPLO_DYNAMIC',
    'DISPID_SPERequiredConfidence', 'SGRSTTWildcard',
    'SPEI_RESERVED3', 'DISPID_SpeechLexiconWords',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRGState',
    'DISPID_SPEPronunciation', 'DISPID_SGRAddState', 'ISpRecognizer3',
    'DISPID_SRCEInterference', 'SAFTADPCM_22kHzMono', 'ISpNotifySink',
    'ISpeechAudioBufferInfo', 'SPSMF_UPS', 'SPEI_SR_RETAINEDAUDIO',
    'SPCT_DICTATION', 'SpeechTokenShellFolder', 'SpInprocRecognizer',
    'SPWORDTYPE', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPAUDIOSTATE', 'eLEXTYPE_PRIVATE5', 'SAFTGSM610_11kHzMono',
    'DISPID_SPRulesItem', 'SPPS_Modifier', 'ISpRecoResult',
    'DISPID_SRRDiscardResultInfo', 'SAFT24kHz8BitMono',
    'DISPID_SpeechAudioStatus', 'SpObjectTokenCategory',
    'eLEXTYPE_RESERVED4', 'DISPID_SLWs_NewEnum',
    'SAFTADPCM_8kHzStereo', 'SSTTTextBuffer',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRCERecognition',
    'DISPID_SLGetPronunciations', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SLPPhoneIds', 'SpeechCategoryAppLexicons', 'SLOStatic',
    'DISPID_SLWWord', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SWFEBlockAlign', 'DISPID_SRIsUISupported', 'SPBO_PAUSE',
    'SPGS_DISABLED', 'DISPID_SpeechGrammarRuleState', 'SpShortcut',
    'ISpeechObjectTokenCategory', 'SVP_18', 'DISPID_SPAsItem',
    'DISPID_SRRGetXMLResult', 'SPPS_Unknown', 'SAFT32kHz8BitMono',
    'SPSInterjection', 'DISPID_SADefaultFormat', 'DISPID_SASetState',
    'Speech_Max_Word_Length', 'STSF_FlagCreate', 'SPRST_ACTIVE',
    'SVP_11', 'DISPID_SpeechRecoResult', 'DISPID_SLPs_NewEnum',
    'SVEStartInputStream', 'SPWT_PRONUNCIATION', 'SPPS_Noncontent',
    'DISPID_SRGCmdLoadFromFile', 'SAFT8kHz16BitMono',
    'SPBOOKMARKOPTIONS', 'DISPID_SRGDictationUnload',
    'SPWAVEFORMATTYPE', 'SVP_19',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SDKGetBinaryValue', 'STCInprocHandler',
    'DISPID_SDKEnumKeys', 'DISPID_SPPsCount', 'SpUnCompressedLexicon',
    'SAFT44kHz8BitStereo', 'STSF_CommonAppData',
    'SpeechVoiceCategoryTTSRate', 'ISpeechPhraseProperties',
    'SDTProperty', 'SPSModifier', 'SLTApp', 'Speech_StreamPos_Asap',
    'DISPID_SPEActualConfidence', 'DISPID_SVEVoiceChange',
    'DISPID_SpeechObjectTokenCategory', 'SASPause',
    'DISPID_SRGSetTextSelection', 'DISPID_SRCreateRecoContext',
    'SVF_Stressed', 'DISPID_SRCERecognizerStateChange',
    'ISpeechMMSysAudio', 'SpTextSelectionInformation',
    'DISPID_SLGetWords', 'DISPID_SpeechPhraseElements',
    'SGSExclusive', 'SREPhraseStart', 'DISPID_SRSetPropertyString',
    'SVP_15', 'eLEXTYPE_APP', 'DISPID_SVSInputSentenceLength',
    'DISPID_SGRName', 'SP_VISEME_15', 'DISPID_SGRSTType',
    'SP_VISEME_6', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRRSpeakAudio', 'SPWORDPRONUNCIATION',
    'DISPID_SRSAudioStatus', 'SpeechPropertyComplexResponseSpeed',
    'SGSDisabled', 'DISPID_SGRs_NewEnum', 'eLEXTYPE_PRIVATE9',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPRULE', 'SRSActiveAlways',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SASFreeBufferSpace',
    'SPRECORESULTTIMES', 'DISPID_SOTCDefault', 'ISequentialStream',
    'DISPID_SABIMinNotification', 'DISPID_SVEEnginePrivate',
    'eLEXTYPE_PRIVATE19', 'SREInterference',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SGRSAddRuleTransition',
    'SREStreamEnd', 'SWTDeleted', 'SPLOADOPTIONS',
    'ISpeechTextSelectionInformation', 'SPSHORTCUTPAIRLIST',
    'DISPIDSPTSI_ActiveOffset', 'SREStateChange',
    'DISPID_SABufferNotifySize', 'DISPID_SGRsItem',
    'SpeechVisemeType', 'ISpeechGrammarRules', 'SPEI_REQUEST_UI',
    'DISPID_SPIProperties', 'SDTDisplayText', 'DISPID_SVDisplayUI',
    'DISPID_SOTGetStorageFileName', 'DISPID_SVStatus',
    'SAFT48kHz8BitStereo', '_SPAUDIOSTATE',
    'DISPID_SRRSetTextFeedback', 'DISPID_SPIGetText', 'SBONone',
    'SRCS_Disabled', 'SVP_20', 'SPEI_SR_BOOKMARK',
    'ISpeechLexiconWord', 'SAFT44kHz16BitStereo', 'SPCS_ENABLED',
    'SREFalseRecognition', 'DISPID_SpeechPhraseRule', 'LONG_PTR',
    'SPBO_AHEAD', 'Speech_Default_Weight', 'SGLexical',
    'SpeechSpecialTransitionType', 'SINone', 'SPAR_Medium',
    'SpeechPropertyResourceUsage', 'SPEI_HYPOTHESIS',
    'DISPID_SVWaitUntilDone', 'SVP_14', 'SRADynamic',
    'SpeechRegistryLocalMachineRoot', 'SpeechUserTraining',
    'DISPID_SpeechMMSysAudio', '_ISpeechRecoContextEvents',
    'SPINTERFERENCE_TOOFAST', 'SpeechCategoryAudioIn',
    'STCLocalServer', 'SDA_One_Trailing_Space', 'SP_VISEME_3',
    'DISPID_SRSClsidEngine', 'DISPID_SPPChildren',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SRCESoundStart',
    'SRERecoOtherContext', 'SGPronounciation', 'SITooQuiet',
    'SPINTERFERENCE', 'SPEI_VOICE_CHANGE', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFTADPCM_11kHzStereo', 'SRSInactive', 'DISPID_SMSAMMHandle',
    'SREPropertyNumChange', 'STCAll', 'ISpeechResourceLoader',
    'SpeechGrammarTagDictation', 'SPFM_OPEN_READONLY', 'SPAS_PAUSE',
    'SVSFNLPMask', 'ISpeechPhraseProperty', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SPPParent', 'ISpDataKey', 'DISPID_SpeechPhraseRules',
    'SPRST_ACTIVE_ALWAYS', 'SpeechDataKeyLocation', 'SpAudioFormat',
    'SpeechMicTraining', 'DISPID_SRGId', 'ISpeechObjectTokens',
    'SVP_4', 'SVP_7', 'SAFTADPCM_22kHzStereo', 'SPCS_DISABLED',
    'DISPID_SASState', 'DISPID_SPACommit', 'SSTTWildcard',
    'SPTEXTSELECTIONINFO', 'SAFTNonStandardFormat', 'SPEI_PHONEME',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPCLangId',
    'DISPID_SRAudioInputStream', 'DISPID_SPRuleConfidence',
    'SPEI_RESERVED5', 'SpNotifyTranslator', 'SPPS_RESERVED4',
    'eLEXTYPE_PRIVATE2', 'SVP_6', 'SPGS_EXCLUSIVE',
    'DISPID_SRCEAudioLevel', 'DISPID_SPIElements', 'DISPID_SBSSeek',
    'DISPID_SpeechDataKey', 'DISPID_SGRSTWeight', 'SPSHORTCUTTYPE',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVSFIsNotXML',
    'DISPID_SLGetGenerationChange', 'SAFT44kHz8BitMono',
    'DISPID_SRCEStartStream', 'DISPID_SOTGetAttribute',
    'DISPID_SRCEPropertyNumberChange', 'eLEXTYPE_MORPHOLOGY',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SGRsFindRule',
    'ISpStreamFormat', 'Speech_StreamPos_RealTime',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFT16kHz16BitMono',
    'DISPID_SpeechObjectTokens', 'SAFTNoAssignedFormat',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRCRequestedUIType',
    'SPPROPERTYINFO', 'ISpObjectToken', 'SpeechAudioVolume',
    'ISpeechPhraseAlternate', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SpeechPhraseProperty', 'ISpeechPhraseRules',
    'SAFTCCITT_uLaw_22kHzMono', 'SRARoot', 'ISpRecoContext',
    'DISPID_SGRAddResource', 'DISPID_SpeechVoice', 'SPAUDIOOPTIONS',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SPEDisplayAttributes',
    'ISpeechXMLRecoResult', 'SPEI_MIN_TTS', 'SpeechCategoryVoices',
    'SpeechVoiceSpeakFlags', 'DISPID_SPRuleChildren',
    'DISPID_SpeechMemoryStream', 'DISPID_SRGCmdSetRuleState',
    'SPAS_RUN', 'SREStreamStart', 'DISPID_SRCEHypothesis',
    'SPPS_RESERVED1', 'SP_VISEME_16', 'DISPID_SRCEFalseRecognition',
    'DISPID_SpeechGrammarRuleStateTransition', 'SpeechAudioState',
    'eLEXTYPE_PRIVATE10', 'DISPID_SRCCreateGrammar',
    'ISpeechPhraseInfo', 'DISPID_SPPs_NewEnum',
    'DISPID_SRGCmdSetRuleIdState', 'ISpRecoContext2', 'SRAExport',
    'SPPS_Verb', 'ISpeechPhraseAlternates',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SREPropertyStringChange',
    'ISpeechPhraseElements', 'SPGS_ENABLED',
    'SAFTCCITT_ALaw_11kHzStereo', 'SRATopLevel', 'SPRS_ACTIVE',
    'SPXRO_SML', 'SDTReplacement', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPWORDPRONOUNCEABLE', 'SPWF_SRENGINE', 'SPAR_Unknown',
    'tagSTATSTG', 'SECFDefault', 'SPFM_CREATE_ALWAYS',
    'eWORDTYPE_DELETED', 'eLEXTYPE_PRIVATE14', 'SITooSlow',
    'SPEI_MAX_TTS', 'SpeechStreamFileMode', 'DISPID_SPEs_NewEnum',
    'DISPID_SDKSetStringValue', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SRSEDone', 'DISPID_SPPName', 'SpeechVoicePriority',
    'DISPID_SRCCreateResultFromMemory', 'ISpeechAudioStatus',
    'ISpeechRecoResult2', 'SpeechCategoryRecognizers',
    'DISPID_SASNonBlockingIO', 'DISPID_SVSpeakCompleteEvent',
    'SpeechDisplayAttributes', 'SDTAudio',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPPEngineConfidence',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPRuleId', 'SVEViseme',
    'SPEVENTENUM', 'DISPID_SVSpeakStream', 'SPRS_INACTIVE',
    'SAFT11kHz16BitMono', 'DISPID_SRCVoice', 'SVP_12',
    'DISPID_SRRTLength', 'SPPS_RESERVED2', 'SAFTDefault',
    'SpeechGrammarState', 'DISPID_SPRuleParent',
    'SpeechVisemeFeature', 'SpNullPhoneConverter',
    'DISPID_SPRuleName', 'SAFTCCITT_uLaw_44kHzMono',
    'SPPS_SuppressWord', 'SVSFParseSapi', 'eLEXTYPE_PRIVATE8',
    'DISPID_SRStatus', 'SGRSTTWord', 'ISpPhoneticAlphabetConverter',
    'DISPID_SpeechFileStream', 'DISPID_SRGetFormat',
    'DISPID_SVSPhonemeId', 'eLEXTYPE_PRIVATE16', 'eLEXTYPE_RESERVED7',
    'ISpeechPhraseRule', 'STSF_AppData', 'SPCT_COMMAND',
    'SREAllEvents', 'SAFT8kHz8BitStereo', 'eLEXTYPE_PRIVATE7',
    ...
    'SPEI_RESERVED2', 'DISPID_SFSOpen', 'SP_VISEME_21',
    'DISPID_SRGIsPronounceable', 'ISpeechRecoContext',
    'DISPID_SpeechPhraseInfo', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SOTCEnumerateTokens', 'SGRSTTRule', 'DISPID_SVResume',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SVEWord',
    'ISpeechLexicon', 'DISPID_SpeechPhraseElement',
    'SpeechAudioFormatType', 'DISPID_SWFEBitsPerSample',
    'DISPID_SPAs_NewEnum', 'SAFT24kHz16BitMono', 'DISPID_SGRsCount',
    'SDTPronunciation', 'DISPID_SRCRetainedAudio',
    'DISPID_SRRTTickCount', 'DISPID_SRRAudioFormat', 'SP_VISEME_10',
    'DISPID_SPIRetainedSizeBytes', 'SITooFast',
    'SPEI_START_INPUT_STREAM', 'SpeechRecoContextState',
    'DISPID_SPEDisplayText', 'DISPID_SVEViseme', 'DISPID_SRProfile',
    'SAFTADPCM_44kHzMono', 'DISPID_SWFEFormatTag', 'ISpPhraseAlt',
    'DISPID_SOTCategory', 'SRCS_Enabled', 'SVSFPurgeBeforeSpeak',
    ...
    'ISpeechRecoResultDispatch', 'SpResourceManager',
    'DISPID_SRGCommit', 'DISPID_SASCurrentSeekPosition', 'SPAR_Low',
    'DISPID_SRGCmdLoadFromMemory', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SAFTCCITT_ALaw_44kHzMono', 'SPEI_INTERFERENCE',
    'SPSEMANTICERRORINFO', 'eLEXTYPE_PRIVATE13',
    'DISPID_SPIAudioStreamPosition', 'SPSSuppressWord',
    'DISPID_SPERetainedSizeBytes',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpRecognizer2',
    'SPSVerb', 'ISpeechMemoryStream', 'ISpeechPhraseInfoBuilder',
    'SPEI_UNDEFINED', 'DISPID_SPRNumberOfElements', 'SP_VISEME_11',
    'DISPID_SDKCreateKey', 'SPEI_SOUND_END', 'SAFT11kHz8BitMono',
    'DISPID_SpeechPhraseAlternate',
    'DISPID_SPANumberOfElementsInResult', 'SASStop',
    'SAFT48kHz16BitStereo', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SLWsItem', 'ISpeechRecoResultTimes', 'SPPS_Noun',
    'DISPID_SPIRule', 'SpVoice', 'DISPID_SpeechGrammarRule',
    'SDTRule', 'ISpRecoCategory', 'SPVPRI_OVER',
    'DISPID_SVSInputWordPosition', 'ISpeechVoice', 'SpeechTokenKeyUI',
    'SPSHT_NotOverriden', 'SVEPhoneme', 'SAFTADPCM_8kHzMono',
    'SAFTCCITT_ALaw_8kHzMono', 'SDA_Consume_Leading_Spaces',
    'SPVOICESTATUS', 'SP_VISEME_17', 'SAFT12kHz8BitStereo',
    'SSSPTRelativeToEnd', 'SPSEMANTICFORMAT', 'DISPID_SVSkip',
    'ISpRecognizer', 'SPFM_OPEN_READWRITE',
    'ISpeechPhraseReplacements', 'SAFTGSM610_22kHzMono',
    'SPRECOSTATE', 'SpeechBookmarkOptions',
    'DISPID_SPIAudioSizeBytes',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SECFIgnoreWidth',
    'DISPID_SVPause', 'SpeechAllElements', 'SVP_2', 'SGRSTTDictation',
    'SPEI_RECOGNITION', 'DISPID_SpeechRecognizer', 'SVPAlert',
    'SPDATAKEYLOCATION', 'SVF_None', 'SAFT11kHz16BitStereo', 'SPSLMA',
    'SLODynamic', 'SPWORDLIST', 'SPEI_TTS_PRIVATE',
    'DISPID_SpeechLexiconProns', 'DISPID_SPRsItem', 'SRERequestUI',
    'SAFT12kHz16BitMono', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SOTSetId', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SVSInputSentencePosition', 'SECFEmulateResult',
    'SDTAlternates', 'DISPID_SLAddPronunciation',
    'DISPID_SLPPartOfSpeech', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPPS_Interjection', 'SRTSMLTimeout',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SMSSetData',
    'DISPID_SGRSTNextState', 'SREBookmark', 'ISpShortcut',
    'ISpGrammarBuilder', 'SP_VISEME_2', 'DISPID_SGRAttributes',
    'DISPID_SVSLastBookmarkId', 'DISPID_SPRsCount',
    'DISPID_SABIEventBias', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SLRemovePronunciation', 'SRSActive', 'SP_VISEME_9',
    'SVP_16', 'SWPUnknownWordPronounceable', 'SECNormalConfidence',
    'SPSERIALIZEDPHRASE', 'DISPID_SGRSTText',
    'SpeechWordPronounceable', 'DISPID_SpeechAudioFormat',
    'DISPID_SPRuleNumberOfElements', 'SPSUnknown', 'SRAONone',
    'SRTReSent', 'SASClosed', 'SPSHORTCUTPAIR', 'SpPhoneConverter',
    'SpSharedRecoContext', 'SDKLLocalMachine', 'ISpeechDataKey',
    'IEnumSpObjectTokens', 'DISPID_SOTDataKey', 'SREAudioLevel',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPPS_LMA',
    'DISPID_SpeechPhraseProperties', 'SPCONTEXTSTATE',
    'SAFTGSM610_44kHzMono', 'SVEWordBoundary', 'eLEXTYPE_PRIVATE20',
    'SAFT44kHz16BitMono', 'SPSERIALIZEDRESULT', 'ISpProperties',
    'SPRST_INACTIVE', 'SGDSActive', 'SDKLCurrentConfig',
    'SP_VISEME_14', 'SVSFIsFilename', 'DISPID_SWFEChannels',
    'DISPID_SOTDisplayUI', 'DISPID_SPIAudioSizeTime',
    'DISPID_SRGRecoContext', 'DISPID_SVRate', 'DISPID_SLPsCount',
    'DISPID_SVSLastStreamNumberQueued', 'SVSFParseSsml',
    'SWPKnownWordPronounceable', 'SpeechAddRemoveWord',
    'SPEI_RESERVED1', 'DISPID_SPRulesCount',
    'SGDSActiveWithAutoPause', 'DISPID_SGRsDynamic',
    'DISPID_SGRSTPropertyName', 'SpeechPropertyAdaptationOn',
    'SAFT22kHz8BitStereo', 'SBOPause', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPLEXICONTYPE', 'SFTInput', 'DISPID_SFSClose',
    'ISpeechCustomStream', 'SpeechRetainedAudioOptions',
    'ISpeechGrammarRuleState', 'eLEXTYPE_PRIVATE18',
    'SPSNotOverriden', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechVoiceEvent', 'SGDisplay', 'DISPID_SABIBufferSize',
    'eLEXTYPE_RESERVED9', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SRCEEndStream', 'DISPID_SAEventHandle',
    'DISPID_SpeechPhraseReplacements', 'SpeechAudioFormatGUIDWave',
    'SPSTREAMFORMATTYPE', 'SPPS_Function', 'DISPID_SVVolume',
    'ISpLexicon', 'DISPID_SpeechGrammarRules', 'eLEXTYPE_PRIVATE1',
    'SVSFParseMask', 'SpeechGrammarWordType', 'DISPID_SRDisplayUI',
    'DISPID_SGRsAdd', 'ISpEventSource', 'DISPID_SMSALineId',
    'SVF_Emphasis', 'DISPID_SRCResume',
    'DISPID_SpeechLexiconPronunciation',
    'DISPIDSPTSI_SelectionLength', 'SPEI_TTS_BOOKMARK', 'SPEVENT',
    'DISPID_SVSpeak', 'SP_VISEME_7', 'SPSHT_EMAIL',
    'SECFIgnoreKanaType', 'DISPID_SGRSRule', 'STCInprocServer',
    'DISPID_SVVoice', 'SPWORD', 'SGSEnabled', 'SPEI_WORD_BOUNDARY',
    'tagSPPROPERTYINFO', 'SpStream', 'DISPID_SGRSTsCount',
    'SAFT16kHz16BitStereo', 'SVSFParseAutodetect',
    'DISPID_SVSVisemeId', 'SAFT8kHz16BitStereo', 'SRTAutopause',
    'DISPID_SOTCSetId', 'SAFTText', 'ISpeechPhraseElement',
    'DISPID_SPRuleEngineConfidence', 'SPEI_SR_AUDIO_LEVEL',
    'SP_VISEME_8', 'SPEI_SR_PRIVATE', 'SSFMOpenReadWrite', 'IStream',
    'SPPHRASEELEMENT', 'SPSNoun', 'DISPID_SVSRunningState',
    'SPAUDIOSTATUS', 'DISPID_SPERetainedStreamOffset',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpeechRecognizer',
    'SPEI_END_SR_STREAM', 'DISPID_SLGenerationId', 'SPVPRI_ALERT',
    'eLEXTYPE_RESERVED6', 'SSFMCreateForWrite', 'SpeechRunState',
    'SREHypothesis', 'SDKLCurrentUser', 'ISpPhoneConverter',
    'ISpResourceManager', 'DISPID_SRCPause', 'SAFT32kHz8BitStereo',
    'DISPID_SRCEAdaptation', 'SPDKL_CurrentConfig',
    'DISPID_SGRSTPropertyValue', 'DISPID_SRCRetainedAudioFormat',
    'ISpPhrase', 'SGRSTTTextBuffer', 'SINoise',
    'SPEI_RECO_STATE_CHANGE', 'SRTExtendableParse', 'ISpStream',
    'ISpeechAudioFormat', 'DISPID_SVEStreamStart', 'ISpXMLRecoResult',
    'ISpEventSink', 'DISPID_SpeechVoiceStatus', 'SAFT8kHz8BitMono',
    'SPVPRI_NORMAL'
]

_check_version('1.2.0', 1633528325.393060)
